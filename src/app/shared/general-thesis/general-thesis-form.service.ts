...
export class GeneralThesisFormService {
  ...
  public $entryForm() : FormGroup {
      ...
      'authorName' : ['' , {'validators' : [Validators.required , Validators.minLength(1) , Validators.maxLength(150)] } ] ,

      'title' : ['' , {'validators' : [Validators.required , Validators.minLength(1) , Validators.maxLength(150)] } ] ,

      'datePublished' : ['' , {'validators' : [Validators.required , Validators.minLength(9) , Validators.maxLength(15)]}] ,

      'description' : ['' , {'validators' : [Validators.required , Validators.minLength(10) , Validators.maxLength(4000)] } ] ,
