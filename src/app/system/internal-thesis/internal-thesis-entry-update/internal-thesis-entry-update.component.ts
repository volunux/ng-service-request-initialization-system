...
@Component({
  ...
  'selector' : 'app-internal-thesis-entry-update',

  'templateUrl' : './internal-thesis-entry-update.component.html',

  'styleUrls' : ['./internal-thesis-entry-update.component.css']

})

export class InternalThesisEntryUpdateComponent implements OnInit {
