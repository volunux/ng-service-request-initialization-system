...
@Component({
  ...
  'selector' : 'app-internal-thesis-entry-delete',

  'templateUrl' : './internal-thesis-entry-delete.component.html',

  'styleUrls' : ['./internal-thesis-entry-delete.component.css']

})

export class InternalThesisEntryDeleteComponent implements OnInit {
