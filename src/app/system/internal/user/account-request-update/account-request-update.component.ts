...
@Component({
	...
	'selector' : 'app-account-request-update',
	
	'templateUrl' : './account-request-update.component.html',
	
	'styleUrls' : ['./account-request-update.component.css'] ,

  'providers' : [NotificationService]

})

export class AccountRequestUpdateComponent extends UserFormService implements OnInit {
  ...
  constructor(public router : Router , public us : UserService , public ns : NotificationService , private route : ActivatedRoute ,
	...
	public title : string = 'Account Request Update';
  ...
  this.removeControls(controls);
    ...
    this.route.paramMap.subscribe((params) => {
      ...
      this.us.updateAcctRequestUser(params.get('entry'))
  ...
  public updateUser(user : User) : any {
    ...
    this.us.$updateAcctRequestUser(this.entryIdx , user)
